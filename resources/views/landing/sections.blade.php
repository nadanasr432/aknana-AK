                ...
                @foreach ($temp_US as $template)
                    ...
                    <div class="col-md-6 ">
                            ...
                            document.addEventListener('DOMContentLoaded', function() {
                                ...
                                if (pElement.scrollHeight > pElement.clientHeight) {
                                    ...
                                    var buttonHTML = '<p class="d-flex justify-content-end">' +
                                        ...
                                        'onclick="openEventModal(\'' + firstWord + ' ' + phraseWithoutFirstLast + ' ' + lastWordClean +
                                        '\', \'' + mainText + '\')">' +
                                        '...' + knowMoreText + '</a></p>';
                        ...
                        <div class="d-flex justify-content-end align-items-between mt-5 ">
                          <a href="" class="d-flex align-items-center pl-4 ">
                        <p class="pr-2"
                            style="font-family: Cairo;
                        font-size: 25px;
                        font-weight: 600;
                        ...
                        ">
                               {{ __('file.about_us') }} </p>
                        <img src="{{ asset('assets/images/orange.png') }}" style="margin-right: 10px;">
                    </a>
                                ...
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        <div class="modal-body">
                                            ...
                                            <div id="event-full-text" class="mt-3"
                                                style="font-family: Cairo !important; font-size: 14px; font-weight: 400; line-height: 25px; letter-spacing: 0em; text-align: right; color:#121743;">
                                                {!! $template->getTranslation('main_text', 'ar') !!}
                                            </div>
                                        </div>
                                    </div>
                            ...
                            @if (strlen($range8->en_text) > 150)
                                <div class="d-flex justify-content-end">
                                    <a class="show-more-btn text-end"
                                        style="color: #DF8317; font-family: Cairo;font-size:12px;" id="range8-text"
                                        data-toggle="modal"
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="center pr-0 text-right mt-2 mb-5 text-right ">
                                ...
                                @if (strlen($range8->ar_text) > 185)
                                    <p class="d-flex justify-content-end">
                                        <a class="show-more-btn text-end"
                                            style="color: #DF8317; font-family: Cairo;font-size:14px;" id="range8-text"
                                            data-toggle="modal"
                                            data-target="#range8-full-text-modal">...@lang('file.know_more')</a>
                                    </p>
                                @endif
                    ...
                    @foreach ($temp_program as $template)
                        <div class="col-md-6">
                            ...
                            <div class="d-flex justify-content-start">
                                ...
                                <span class="d-flex justify-content-center pr-0" data-target="#carouselExampleIndicators"
                                    data-slide="next">
                                    <img src="{{ asset('images/arrow_left.png') }}" alt="Next" width="43px" height="43px"  style="transform: scaleX(-1);">
                                </span>
                            </div>
    ...
    <section class="reviews container text-center mt-5 mb-5" id="reviews"
        ...
        <div class="row d-flex justify-content-center mt-5 mb-5">
            <div class="center mt-5"
                style="font-family: Cairo; font-size: 35px; font-weight: 667; line-height: 50px; letter-spacing: 0em; text-align: center; color:#121743;">
                <img src="{{ asset('images/Vector (1).svg') }}">
                @lang('file.Find out what')
                <span
                    style="color: #DF8317; font-family: Cairo; font-size: 35px; font-weight: 667; line-height: 50px; letter-spacing: 0em; text-align: center;">
        ...
        @if (app()->getLocale() == 'ar')
            <div class="row d-flex justify-content-center">
                <div id="carouselExampleIndicators3" class="carousel slide" data-ride="carousel" style="height:auto">
                    <div class="d-flex justify-content-between">
                        <span id="arrow" class="d-flex justify-content-center" style="margin-top:8rem !important;"
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <div class="card"
                                    style="width: 100%; height:100%; border:#F8F8F8; border-radius: 12px; background-color: #F8F8F8;">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-center">
                                            <p class="card-text text-center"
                                                style="font-family: Poppins; font-size: 20px; border:#F8F8F8; font-weight: 400; line-height: 32px; letter-spacing: 0em; text-align: center; color:#637381;">
                                                من أفضل الشركات اللي اتعملت معاهم قمة في الانضباط والتمييز والمتابعة انصح اي
                                                شخص محتاج يبدأ في شركته الخاصة وما عنده خطة موضحة يتواصل معاهم وهما بيساعده
                                                في تحقيق اي شئ وجعل المستحيل ممكن
                                            </p>
                                        </div>
                                        <div class="d-flex justify-content-center mt-4">
                                            <p
                                                style="font-family: Cairo; font-size: 30px; font-weight: 600; line-height: 56px; letter-spacing: 0em; text-align: center; color:#222751;">
                                                طلال بن سلمان
                                            </p>
                                        </div>
                                        <div class="d-flex justify-content-center mt-4">
                                            <p
                                                style="font-family: Cairo; font-size: 20px; font-weight: 500; line-height: 37px; letter-spacing: 0em; text-align: center; color:#F0A202;">
                                                مؤسس شركة
                                            </p>
                                        </div>
                                    </div>
                        ...
                        <span class="d-flex justify-content-center mb-4" style="margin-top:8rem !important;"
                            data-target="#carouselExampleIndicators3" data-slide="next">
                            <img src="{{ asset('images/arrow_reverse.png') }}" alt="Next"  width="43px" height="43px">
                        </span>
                    </div>
            ...
            <div class="row d-flex justify-content-center">
                <div id="carouselExampleIndicators3" class="carousel slide" data-ride="carousel" style="height:auto">
                    <div class="pl-5 d-flex justify-content-between" style="padding-left: 5rem !important;">
                        <span class="d-flex justify-content-center mb-4 pr-2" style="margin-top:8rem !important;"
                            data-target="#carouselExampleIndicators3" data-slide="prev">
                            <img src="{{ asset('images/arrow_reverse.png') }}" alt="Previous"  width="43px" height="43px">
                        </span>
                        <div class="carousel-inner">
                        ...
                        <span class="pl-2" style="margin-top:8rem !important;"
                            data-target="#carouselExampleIndicators3" data-slide="next">
                            <img src="{{ asset('images/arrow_left.png') }}" alt="Next" class="next" width="43px" height="43px" style="transform: scaleX(-1);">
                        </span>
                    </div>
                    <a class="carousel-control-prev" href="#carouselExampleIndicators3" role="button"
                        data-slide="prev">
