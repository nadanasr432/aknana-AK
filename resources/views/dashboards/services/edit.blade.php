    ...
    <div class="content-wrapper">
        ...
        <div class="row">
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title mb-5">@lang('file.Edit Service')</h4>
                        @if ($errors->any())
                        ...
                        <form method="POST"action="{{ route('dashboard.service.update', $service->id) }}"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title[en]" id="title_en" class="form-control"
                                            value="{{ $service->getTranslation('title', 'en') }}" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title[ar]" id="title_ar" class="form-control"
                                            value="{{ $service->getTranslation('title', 'ar') }}" required>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea name="description[en]" value="{{ $service->getTranslation('description', 'en') }}" id="description_en"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea name="description[ar]" value="{{ $service->getTranslation('description', 'ar') }}" id="description_ar"
                                            class="form-control" required></textarea>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="image">@lang('file.Service Image') <img
                                                src="{{ asset('storage/' . $service->media()->first()->file_path) }}"
                                                width="40px" height="40px"></td></label>
