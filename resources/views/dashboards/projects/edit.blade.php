    ...
    <div class="content-wrapper">
        ...
        <div class="row">
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title mb-5">@lang('file.Edit Project')</h4>
                        @if ($errors->any())
                        ...
                        @endif
                        <form method="POST"action="{{ route('dashboard.project.update', $project->id) }}"
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="image">@lang('file.Project Image') <img
                                                src="{{ asset('storage/' . $project->images()->first()->file_path) }}"
