        ...
        @if (app()->getLocale() == 'ar')
            @foreach ($temp_reservations as $template)
                <div class="row d-flex justify-content-between">
                    ...
                    <div class="col-md-5">
                        <img src="{{ asset('storage/' . $template->image) }}"width="585px" height="578px" class="img-fluid"
                            alt="About Us Image">
                    </div>
                    ...
                    ">
                        ...
                        <form id="reservationForm" action="{{ route('reservation.store') }}" method="post">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group mb-5 col-md-6 ml-auto text-left">
                                    <select class="form-control text-left custom-arrow-select" id="course_id"
                                        name="course_id"
                    ...
                    line-height: 50px; letter-spacing: 0em; text-align: center; padding-left: 31px;">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group mb-5 col-md-6 ml-auto text-left">
                                    <input type="text" name="entity_name" class="form-control text-left"
                            ...
                            <div class="form-row">
                                <div class="form-group mb-5 col-md-6 ml-auto text-left">
                                    <select class="form-control text-left custom-arrow-select2" id="gender"
                                        name="gender"
                                        style="width: 100%; height: 70px; border-radius: 10px; border: 1px #F2F2F2; gap: 98px;
                                background-color:#F9F9F9; font-family: Cairo; font-size: 18px; font-weight: 400;
                                line-height: 50px; letter-spacing: 0em; text-align: center;padding-left: 31px;">
                                    ...
                                    <img src="{{ asset('images/gender.svg') }}" class="pr-l custom-arrow"
                                        alt="Custom Arrow" style="margin-top: -100px; margin-left: 2px;">
                                    <img src="{{ asset('images/Vector (7).svg') }}" class="pr-2 custom-arrow"
                                        alt="Custom Arrow2" style="margin-left: 340px;">
                                </div>
                    ...
                    line-height: 50px; letter-spacing: 0em; text-align: center;">
                            ...
                            <div class="form-row">
                                ...
                                line-height: 50px; letter-spacing: 0em; text-align: center;">
                                    ...
                                    <img src="{{ asset('images/gender.svg') }}" class="pr-2 custom-arrow"
                                        alt="Custom Arrow"
